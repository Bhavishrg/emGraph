...
class OnlineEvaluator {
  ...
  common::utils::LevelOrderedCircuit msb_circ_;
 ...
 public:
  OnlineEvaluator(int id, std::shared_ptr<io::NetIOMP> network,
                  PreprocCircuit<Ring> preproc, common::utils::LevelOrderedCircuit circ,
...
struct BoolEvaluator {
  ...
  void evaluateAllLevels(io::NetIOMP& network, JumpProvider& jump,
                         ThreadPool& tpool);
