...
agg.write("\nOnline time: " + str(max_time) + "\n")
agg.write("Online comm: " + str(online_comm) + "\n")
agg.write("Max time party: " + max_p + "\n")

agg.write("\nPreproc time: " + str(preproc_time) + "\n")
agg.write("Preproc comm: " + str(preproc_comm) + "\n")
agg.close()
